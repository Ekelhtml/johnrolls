...
<div class='social-container' id='social-container'>
      <h1>Social Follow</h1>
      <a href='https://www.instagram.com/johnrollscomposer/' 
        className='instagram social' target='_blank' rel='noreferrer'>
        <FaInstagram  />
      </a>
      <a href='https://www.youtube.com/@johnrollsComposer'
        className='youtube social' target='_blank' rel='noreferrer'>
        <FaYoutube  />
      </a>
      <a href='https://www.facebook.com/Juanerolls'
        className='facebock social'target='_blank' rel='noreferrer' >
        <FaFacebookSquare  />
      </a>
</div>
  )
